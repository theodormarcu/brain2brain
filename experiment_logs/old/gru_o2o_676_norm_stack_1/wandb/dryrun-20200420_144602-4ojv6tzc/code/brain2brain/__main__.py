...
def main():
    ...
    if experiment_name == "tcn_experiment":
        ...
        tcn_experiments.tcn_m2o_seq(experiment_params)
    ...
    elif experiment_name == "gru_m2o_seq":
        gru_experiments.gru_m2o_seq(experiment_params)
    elif experiment_name == "gru_o2o_stack":
        gru_experiments.gru_o2o_stack(experiment_params)
